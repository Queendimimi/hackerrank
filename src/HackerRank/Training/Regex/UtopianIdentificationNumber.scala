...
/**
  ...
  *
  * @author A. Roberto Fischer <a.robertofischer@gmail.com> on 8/25/2017
  */
private[this] object UtopianIdentificationNumber {
  ...
  private[this] def solve(): Unit = {
    val n = next[Int]()
    next[String, Vector](n)
      .map("^[a-z]{0,3}\\d{2,8}[A-Z]{3,}$".r.unapplySeq)

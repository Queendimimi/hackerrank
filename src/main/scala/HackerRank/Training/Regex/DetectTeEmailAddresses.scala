...
/**
  ...
  *
  * @author A. Roberto Fischer <a.robertofischer@gmail.com> on 9/7/2017
  */
private[this] object DetectTeEmailAddresses {
  ...
  private[this] final object Reader {
    ...
    private[this] def isSpaceChar(c: Int) = (c < 33 || c > 126) && c != 10 && c != 32 && c != 9

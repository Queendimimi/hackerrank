...
/**
  ...
  */
private[this] object MaximizingXor {
  ...
  private[this] def solve(): Unit = {
    ...
    val significantBit = 31 - (left ^ right).numberOfLeadingZeros
    println((1 << (significantBit + 1)) - 1)
  }
  ...
  object Implicits {
    ...
    final implicit class ExtendedRichInt(val self: Int)
      ...
      def highestOneBit: Int = java.lang.Integer.highestOneBit(self)

      def lowestOneBit: Int = java.lang.Integer.lowestOneBit(self)

      def numberOfLeadingZeros: Int = java.lang.Integer.numberOfLeadingZeros(self)

      def numberOfTrailingZeros: Int = java.lang.Integer.numberOfTrailingZeros(self)

      def bitCount: Int = java.lang.Integer.bitCount(self)
    }

...
/**
  ...
  *
  * @author A. Roberto Fischer <a.robertofischer@gmail.com> on 5/18/2017
  */
private[this] object ViralAdvertising {
  ...
  private[this] def solve(): Unit = {
    val n = nextInt()
    println(countLikes(n))
  }

  private[this] def countLikes(n: Int) = {
    def _count(n: Int, k: Int, sum: Int): Int = {
      if (n > 0) _count(n - 1, k * 3 / 2, sum + k * 3 / 2) else sum
    }
